...
type StockClient interface {
	SendStock(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductReply, error)
}
...
func (c *stockClient) SendStock(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductReply, error) {
	out := new(ProductReply)
	err := c.cc.Invoke(ctx, "/Stock/SendStock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StockServer interface {
	SendStock(context.Context, *ProductRequest) (*ProductReply, error)
...
func (UnimplementedStockServer) SendStock(context.Context, *ProductRequest) (*ProductReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendStock not implemented")
}
...
func _Stock_SendStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServer).SendStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Stock/SendStock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServer).SendStock(ctx, req.(*ProductRequest))
	}
...
var Stock_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendStock",
			Handler:    _Stock_SendStock_Handler,
		},
	},
